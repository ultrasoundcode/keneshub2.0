      ...
      >
        <div className="bg-white rounded-[32px] border border-zinc-200 shadow-[0_4px_24px_rgba(0,0,0,0.06)] min-h-[180px] md:min-h-[220px] relative pb-20 transition-all duration-300">
          <textarea 
            ...
            className="w-full bg-transparent resize-none outline-none text-zinc-900 placeholder:text-zinc-400 text-xl px-6 py-6 md:px-8 md:py-8 max-h-[300px] overflow-y-auto"
          />
